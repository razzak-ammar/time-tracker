...
export function Navigation({
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          "group/sidebar fixed left-0 top-0 z-40 md:z-auto h-[100dvh] md:h-full w-72 md:w-64 transform bg-card/95 dark:bg-gray-900/95 backdrop-blur-xl border-r border-border/80 shadow-2xl transition-all duration-300 ease-in-out md:translate-x-0 md:shadow-none md:static md:top-auto md:min-h-0 md:overflow-y-auto",
          isOpen ? "translate-x-0" : "-translate-x-full",
          collapsed && "md:w-16 md:hover:w-64",
        )}
      >
        {/* Mobile Header */}
        <div className="flex items-center justify-between p-4 border-b border-border/80 md:hidden">
        ...
        <div className="flex flex-col h-full">
          ...
          <div
            className={cn(
              "p-4 border-t border-border/80 transition-[padding] duration-200",
              collapsed && "md:p-2",
            )}
          >
            <div
